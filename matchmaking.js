...
import { db, auth }          from './firebase.js?v=1.3.2';
import { ref, set, get, update, onValue, off, push, remove, query, orderByChild, limitToLast }
                               from 'https://www.gstatic.com/firebasejs/10.12.0/firebase-database.js';
import { MP, currentUser, setCurrentUser, getCurrentUser, TURN_TIMEOUT_MS, ABANDON_MS, showScreen, authCallbacks } from './shared.js?v=1.3.2';
import { G, POOL, SETTINGS, tierOf, initGame, renderAll, showWinner,
         doInsert as _origDoInsert, resetGame as _origResetGame } from './game.js?v=1.3.2';
