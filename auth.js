...
import { auth, db }           from './firebase.js?v=1773704244';
...
import { setCurrentUser, MP, showScreen, authCallbacks } from './shared.js?v=1773704244';
let currentUser = null; // local mirror
import { initGame, renderAll, switchTab, resetPieceValues, closeSettings, applySettings, openSettings } from './game.js?v=1773704244';
import { cleanupMP, playLocal, showQuickMatch, cancelQuickMatch,
         ...
         startOnlineGame } from './matchmaking.js?v=1773704244';
